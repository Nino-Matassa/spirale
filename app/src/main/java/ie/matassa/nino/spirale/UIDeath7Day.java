...
public class UIDeath7Day extends UI implements IRegisterOnStack {
  ...
  public UIDeath7Day(Context context, int regionId, int countryId) {
	...
	private void populateTable() {
	  ...
	  String sqlDetail = "select Date, Country, Region, NewDeaths as NewCases from Detail where FK_Country = #1 order by date desc".replace("#1", String.valueOf(countryId));
