...
//	  String sqlDetail = "select distinct Date, NewCase as CaseX, Detail.Region, Detail.Country from Detail where FK_Country = #1 order by date desc".replace("#1", String.valueOf(countryId));
