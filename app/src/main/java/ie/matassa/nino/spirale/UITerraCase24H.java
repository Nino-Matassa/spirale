...
public class UITerraCase24H extends UI implements IRegisterOnStack {
  ...
  public UITerraCase24H(Context context, int regionId, int countryId) {
	super(context, Constants.UITerraCase24H);
	this.context = context;
	this.regionId = regionId;
	this.countryId = countryId;
	UIMessage.informationBox(context, "Cases over the last 24 hours.");
  ...
  public void registerOnStack() {
	uiHistory = new UIHistory(regionId, countryId, Constants.UITerraCase24H);
