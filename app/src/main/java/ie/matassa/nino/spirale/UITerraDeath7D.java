...
public class UITerraDeath7D extends UI implements IRegisterOnStack {
  ...
  public UITerraDeath7D(Context context, int regionId, int countryId) {
	...
	private void populateTable() {
	  ...
	  String sql = "select distinct Country.Id, Country.FK_Region, Country.Country, Overview.Death7Day from Country join Overview on Country.Country = Overview.Country order by Overview.Case7Day desc";
